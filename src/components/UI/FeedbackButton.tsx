/**
 * Feedback Button Component for MyFace SnapJournal
 * 
 * This component provides feedback buttons that can be integrated into the sidebar
 * or used as floating elements, allowing users to submit feedback and create GitHub issues.
 */
