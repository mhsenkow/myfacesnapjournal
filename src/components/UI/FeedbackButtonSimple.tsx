...
const FeedbackButtonSimple: React.FC<FeedbackButtonSimpleProps> = ({ 
  ...
  const buttonClasses = variant === 'inline' 
    ? "p-sm glass-subtle border border-neutral-200 dark:border-neutral-700 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all duration-200 group flex items-center gap-sm w-full"
    : "p-md glass-panel glass-subtle border border-neutral-300 dark:border-neutral-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group"
    ...
    return (
      <div className={`space-y-sm ${className}`}>
        <button
          ...
          title="Report a Bug"
        >
          <Bug className={`${iconClasses} group-hover:text-semantic-error transition-colors`} />
        ...
        >
          <Lightbulb className={`${iconClasses} group-hover:text-semantic-warning transition-colors`} />
        ...
        <button
          ...
          title="Send Feedback"
        >
          <MessageCircle className={`${iconClasses} group-hover:text-semantic-info transition-colors`} />
  ...
  return (
    <div className={`fixed bottom-20 left-4 z-[60] flex flex-col gap-sm ${className}`}>
      <button
        onClick={() => handleFeedbackClick('bug')}
        className={buttonClasses}
        title="Report a Bug"
