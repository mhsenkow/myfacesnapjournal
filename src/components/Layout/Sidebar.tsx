                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative ${
                    active
                      ...
                      : 'glass-text-secondary hover:bg-neutral-50 dark:hover:bg-neutral-800/50 hover:text-neutral-900 dark:hover:text-neutral-100 hover:scale-[1.02]'
                  }`}
                ...
                >
                  <div className={`p-1 rounded-lg transition-all duration-200 ${
                    active 
                      ...
                      : 'group-hover:bg-neutral-100 dark:group-hover:bg-neutral-700'
                  }`}>
        ...
        <div className="p-4 border-t border-neutral-200 dark:border-neutral-700 flex-shrink-0">
          {activeProfile ? (
            ...
            <div className="flex items-center gap-3 p-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-neutral-700 dark:text-neutral-300 truncate">Welcome!</p>
